...
+ In the description that follows the term "theme directory" refers to a path made up of the working directory, "themes" and the theme name. For example, if the current theme is called "mytheme", theme directory is: &lt;working directory&gt;/themes/mytheme.
